...
<head>
    ...
    if(isset($_GET['id']))
        $id=$_GET['id'];
        //obtener los datos para buscar el libro
        $query="SELECT l.id,titulo,nombre,appaterno,apmaterno,fecha,precio,imagen,descripcion FROM libro l, autor a WHERE l.id=$id";
        $consultaLibro=$mysqli->query($query);
        $resultado=$consultaLibro->fetch_assoc();
    //demas consultas    
...
<body>
    ...
    <div class="col-sm-6 central" style="width: auto; margin: auto auto;" >
        <div class="card" text-center>
            <div class="card-body">
                <!--INICIO CUESTIONARIO------------------------------------------------------------------->
                <form enctype="multipart/form-data" action="controllerLibros/modificarLibro.php" method="post">
                <h3 class="card-title" >Agregar nuevo libro</h3><br><br>
                <div class="form-row">
                    <div class="col">
                        <label class="card-text">Ingrese el titulo:</label><br>
                        <input type="text" id="titulo" name="titulo" class="form-control form-control-sm" value='<?php echo $resultado['titulo'];?>' required="required" />
               <!-- <div id="mensaje1" class="errores"> Dato no valido</div>-->
                ...
                <div class="form-row">
                    <div class="col">
                        <input type="text" class="form-control" id="autor" name="autor" placeholder="Nombre" value='<?php echo $resultado['nombre'];?>' required="required">
                    </div>
                    <div class="col">
                        <input type="text" class="form-control" id="autorap" name="autorap" placeholder="Apellido Paterno" value='<?php echo $resultado['appaterno'];?>' required="required">
                    </div>
                    <div class="col">
                        <input type="text" class="form-control" id="autoram" name="autoram" placeholder="Apellido Materno" value='<?php echo $resultado['apmaterno'];?>' >
                    </div>
                </div><br>
                <div class="form-row">
                    <div class="col">
                    ...
                    <div class="col">
                        ...
                        <input type="number" id="fecha" name="fecha" value='<?php echo $resultado['fecha'];?>' class="form-control form-control-sm"/><br>
                    </div>
                </div>
                <div class="form-row">
                    <div class="col">
                ...
                <div class="form-row">
                    <div class="col">
                        <label class="card-text">Ingrese el precio del libro:</label><br>
                         <input type='number' step='0.01' value='<?php echo $resultado['precio'];?>' placeholder='0.00' id="precio" name="precio" class="form-control form-control-sm"/><br>
                    </div>
                    <div class="col">
                ...
                <div class="form-row">
                        ...
                        <textarea id="des" name="des" rows="8" cols="30" class="form-control form-control-sm"><?php echo $resultado['descripcion'];?></textarea>
                       <!---------------------------MANDAR EL ID DEL LIBRO--------------------------------->
                       <input type="hidden" id="libro" name="libro" value="<?php echo $resultado['id']; ?>" class="form-control form-control-sm"/>
                   </div> <br>
                <center><input id="btn" type="submit"  value="Actualizar" class="btn btn-success"  style="width: 330px; 
